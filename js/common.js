...
jQuery(document).ready(function(){
	document.onmousemove = function (ev) {
		...
		jQuery('#cover').css({'top':oEvent.clientY + scrollTop + 'px','left':oEvent.clientX + scrollLeft + 'px'});

		jQuery('.circle-one').css('transform','translateX('+(2*((oEvent.clientX + scrollLeft)/jQuery(window).width())-1)+'vw) translateY('+(((oEvent.clientY + scrollTop)/jQuery(window).height()-0.5))+'vw)');
		jQuery('.circle-two').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');
		jQuery('.circle-three').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');
		jQuery('.circle-four').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');
		jQuery('.circle-five').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');
		jQuery('.circle-six').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');
		jQuery('.circle-seven').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');
		jQuery('.circle-eight').css('transform','perspective(600px) rotateY('+(5*((oEvent.clientX + scrollLeft)/jQuery(window).width())-5)+'deg) translateY('+((oEvent.clientY + scrollTop)/jQuery(window).height())+'vw)');    

		if(((oEvent.clientX + scrollLeft)/jQuery(window).width())>0.4 && ((oEvent.clientX + scrollLeft)/jQuery(window).width())<0.6 && ((oEvent.clientY + scrollTop)/jQuery(window).height())>0.3 && ((oEvent.clientY + scrollTop)/jQuery(window).height())<0.7 ){
			jQuery('.contain div:nth-of-type(2)').removeClass('first');
			jQuery('.contain div:nth-of-type(3)').removeClass('second');
			jQuery('.contain div:nth-of-type(4)').removeClass('third');
			jQuery('.info img:nth-of-type(2)').removeClass('up-animation');
			jQuery('.contain div:nth-of-type(2)').addClass('box-animation');
			jQuery('.contain div:nth-of-type(3)').addClass('box-animation-two');
			jQuery('.contain div:nth-of-type(4)').addClass('box-animation-two');
			jQuery('.info img:nth-of-type(2)').addClass('down-animation');
		}else{
			jQuery('.contain div:nth-of-type(2)').removeClass('box-animation');
			jQuery('.contain div:nth-of-type(3)').removeClass('box-animation-two');
			jQuery('.contain div:nth-of-type(4)').removeClass('box-animation-two');
			jQuery('.info img:nth-of-type(2)').removeClass('down-animation');
			jQuery('.contain div:nth-of-type(2)').addClass('first');
			jQuery('.contain div:nth-of-type(3)').addClass('second');
			jQuery('.contain div:nth-of-type(4)').addClass('third');
			jQuery('.info img:nth-of-type(2)').addClass('up-animation');
		}
	  };
	...
	loadingTime=setInterval(function(){
		if(loadingStep>=5){
			loadingStep=1;
			jQuery('.preloadTxt').html("•");
		}
		else{
			loadingStep++;
			jQuery('.preloadTxt').append("•");
		}
	},500);
});
